...
from backbone import ShuffleNetV2SE
...
def create_model(num_classes):
    ...
    # vgg16
    backbone = ShuffleNetV2SE(Num_classes=num_classes, channel_ratio=1.0)
    # print(backbone)
    backbone = create_feature_extractor(backbone, return_nodes={"conv5.2": "0"})
...
if __name__ == "__main__":
    ...
    # 训练数据集的根目录(VOCdevkit)
    parser.add_argument('--data-path', default='D:/Dataset/', help='dataset')
    # 检测目标类别数(不包含背景)
